...
const App: React.FC = () => {
      ...
      const initCamera = async () => {
        ...
        try {
          ...
          if (videoRef.current) {
            ...
            // Aumento do delay para 1000ms para evitar 'setPhotoOptions failed'
            // Alguns dispositivos Android levam tempo para registrar as capacidades de hardware
            setTimeout(() => {
  ...
  const formatErrorMessage = (err: any) => {
    ...
    return "Ocorreu um problema na análise. Verifique sua conexão ou tente novamente.";
  };
    ...
    try {
      ...
      if (res.pestFound && user) {
        await supabase.from('pest_detections')
          .insert({ 
            user_id: user.id, 
            image_data: publicUrl, // Agora salvamos apenas o LINK
