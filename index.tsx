...
const ENCYCLOPEDIA_DATA: EncyclopediaItem[] = [
  ...
  { 
    ...
    details: {
      ...
      characteristics: ['Pequena (3-4cm com pernas)', 'Cor marrom-claro a acinzedado', 'Mancha em formato de violino no cefalotórax'],
      anatomy: 'Corpo dividido em cefalotórax e abdômen. Possui 6 olhos dispostos em 3 pares.',
      members: '8 pernas finas e longas, pedipalpos pequenos.',
      habits: 'Sedentária e não agressiva. Vive em ambientes escuros e secos: atrás de quadros, móveis e roupas.',
      ...
      controlMethods: ['Limpeza profunda com aspirador de pó', 'Inspeção de roupas e calçados antes do uso'],
      physicalMeasures: ['Aspirar atrás de móveis e rodapés', 'Sacudir sapatos e roupas de cama'],
      chemicalMeasures: ['Piretróides microencapsulados em frestas', 'Tratamento perimetral'],
      healthRisks: 'Veneno proteolítico que causa necrose tecidual severa e falência renal em casos graves.'
    }
  },
  { 
    ...
    details: {
      ...
      habits: 'Comum em cozinhas, motores de eletrodomésticos e frestas de armários.',
      reproduction: 'A fêmea carrega a ooteca até momentos antes da eclosão (30-40 ovos).',
      larvalPhase: 'As ninfas passam por 6 a 7 mudas. São menores e não possuem asas.',
      controlMethods: ['Aplicação de iscas em gel', 'Monitoramento com armadilhas adesivas'],
      physicalMeasures: ['Limpeza profunda de gordura', 'Vedar frestas em azulejos'],
      chemicalMeasures: ['Gel isca de alta atratividade', 'Reguladores de crescimento (IGR)'],
      healthRisks: 'Transmissão de patógenos (Salmonella) e causadora de asma e rinites.'
    }
  },
  { 
    ...
    details: {
      ...
      characteristics: ['Grande (até 5cm)', 'Cor marrom-avermelhada brilhante'],
      ...
      larvalPhase: 'As ninfas levam de 6 a 12 meses para atingir a maturidade sexual.',
      controlMethods: ['Barreira química perimetral', 'Saneamento básico'],
      physicalMeasures: ['Instalação de ralos do tipo "abre-fecha"', 'Vedação de esgotos'],
      chemicalMeasures: ['Desinsetização líquida por pulverização', 'Iscas granuladas externas'],
      healthRisks: 'Vetor de doenças entéricas transportando bactérias de esgotos.'
    }
  },
  { 
    ...
    details: {
      ...
      characteristics: ['Pequena (1.2cm)', 'Duas faixas transversais claras'],
      anatomy: 'Asas do macho ultrapassam o abdômen.',
      members: '6 pernas ágeis.',
      habits: 'Prefere locais altos e secos como estantes e motores de TV.',
      reproduction: 'A fêmea cola a ooteca em superfícies altas (14-18 ovos).',
      larvalPhase: 'Ninfas possuem as faixas transversais muito nítidas.',
      controlMethods: ['Aplicação focal de gel em locais altos', 'Limpeza de eletrônicos'],
      physicalMeasures: ['Remover acúmulo de papéis', 'Vedar furos em móveis'],
      chemicalMeasures: ['Iscas em gel específicas para locais secos'],
      healthRisks: 'Contaminação de equipamentos eletrônicos e potencial alergênico.'
    }
  },
  { 
    ...
    details: {
      ...
      characteristics: ['Cor avermelhada', 'Picada que causa pústulas brancas'],
      anatomy: 'Cintura com dois nós. Antenas com 10 segmentos.',
      members: '6 pernas.',
      habits: 'Constrói montículos de terra solta. Ataca em massa.',
      reproduction: 'Colônias podem ter várias rainhas (poligínicas).',
      larvalPhase: 'As larvas são alimentadas com comida regurgitada.',
      controlMethods: ['Iscas granuladas ao redor do ninho', 'Tratamento de montículos'],
      physicalMeasures: ['Eliminar acúmulo de terra', 'Manter gramados aparados'],
      chemicalMeasures: ['Iscas granuladas com Hidrametilnona', 'Fipronil líquido'],
      healthRisks: 'Veneno causa dor intensa e risco de choque anafilático.'
    }
  },
  { 
    ...
    details: {
      ...
      characteristics: ['Cor avermelhada', 'Abdômen globoso'],
      anatomy: 'Cefalotórax avermelhado. Pernas finas.',
      members: '8 pernas longas.',
      habits: 'Vive em cantos de paredes e atrás de móveis. Teias irregulares.',
      reproduction: 'A fêmea produz várias ootecas esféricas suspensas na teia.',
      larvalPhase: 'Os filhotes são independentes logo após a eclosão.',
      controlMethods: ['Remoção mecânica de teias', 'Limpeza periódica'],
      physicalMeasures: ['Vedar frestas em rodapés', 'Aspirar cantos altos'],
      chemicalMeasures: ['Inseticidas domésticos aerossóis'],
      healthRisks: 'Picada causa dor local leve e vermelhidão.'
    }
  },
  { 
    ...
    details: {
      ...
      characteristics: ['Muito agressiva', 'Levanta as patas dianteiras'],
      anatomy: 'Grande (até 15cm). Quelíceras com pelos avermelhados.',
      members: '8 pernas longas e ágeis.',
      habits: 'Errante e noturna. Esconde-se em sapatos e bananeiras.',
      reproduction: 'A fêmea produz várias ootecas ao longo da vida.',
      larvalPhase: 'Ninfas agressivas e rápidas desde o nascimento.',
      controlMethods: ['Inspeção rigorosa', 'Vedação total de frestas'],
      physicalMeasures: ['Sacudir roupas e sapatos', 'Vedar portas com borracha'],
      chemicalMeasures: ['Inseticidas profissionais de choque'],
      healthRisks: 'Veneno neurotóxico potente. Risco de morte em crianças.'
    }
  }
];
